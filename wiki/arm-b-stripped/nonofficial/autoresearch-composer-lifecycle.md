...
| `data/lifecycle/golden_dataset_versions.json` | `autoresearch-pr-golden@2026-07-23` and `autoresearch-nightly-golden@2026-07-23`, with 4 and 3 cases |
| `data/lifecycle/eval_runs/autoresearch_composer_2026-07-23.json` | the recorded run summary |
| `data/lifecycle/promotion_records.json` | promotion decisions, still unadmitted |
...
- **No real-driver evidence for this asset.** Every number above comes from a deterministic simulation
  ...
  `scripts/real_driver_ablation.py`,
